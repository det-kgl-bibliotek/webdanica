...
public class TestRules {
    ...
    public static void main(String[] args) throws Exception {
        ...
        Iterator<SingleCriteriaResult> results = null;
        if (onlyOneUrl) {
        ...
        if (results != null) {
            ...
            if (onlyOneUrl) {
                System.out.println("Found " + cdao.getResultsByUrlCount(url) + " criteria results for url '" + url + "'");
            } else {
                System.out.println("Found " + cdao.getResultsByUrlCount(null) + " criteria results in database");
            }
